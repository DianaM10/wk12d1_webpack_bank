...
describe('bank', function() {
  ...
  it("should add 10% interest to all accounts", function() {
    var bank = new Bank();
    var account1 = new Account({owner:'Jay',amount:50, type:'business'});
    var account2 = new Account({owner:'Val',amount:150, type:'business'});
    var account3 = new Account({owner:'Kieth',amount:150, type:'personal'});
    ...
    assert.equal(55, bank.accounts[0].amount.toFixed(2));
    assert.equal(165, bank.accounts[1].amount.toFixed(2));
    assert.equal(165, bank.accounts[2].amount.toFixed(2));
